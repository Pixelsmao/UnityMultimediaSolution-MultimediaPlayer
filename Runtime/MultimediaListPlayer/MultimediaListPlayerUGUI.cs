...
namespace Pixelsmao.UnityMultimediaSolution.MultimediaPlayer
{
    ...
    public class MultimediaListPlayerUGUI : MonoBehaviour
    {
        ...
        public void UpdateMediaSegments(List<MediaSection> mediaSegments, IMultimediaPlayer player)
        {
            throw new NotImplementedException();
        }

        public void UpdateMediaSegments(List<MediaSection> mediaSegments, IMediaPlayer player)
        {
